        ...
        <?php }elseif($block_type === 'contact'){ ?>
         ...
         <?php }elseif($block_type === 'about_us'){ ?>
          ...
          <?php if(isset($block_post)){ ?>
              ...
              <section class="about about-description" style="<?php if(isset($background_color) && !empty($background_color)) {?>background: <?php echo esc_attr($background_color);}?>; <?php if(isset($background_image) && !empty($background_image)){?>background-image: url(<?php echo esc_url($background_image[0]);}?>);background-size:cover;">
                <div class="container">
